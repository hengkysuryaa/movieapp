    ...
    render() {
        return(
            <div className='wrapper'>
                ...
                <div className='wrapper-item'>
                    <center>
                    <img className='picture' alt='none' src="https://resizing.flixster.com/lcvmsqR_mRMF6J093vq1qTnvFqo=/206x305/v2/https://resizing.flixster.com/R79OT2OvhEzHPVdgkCCV_ur1eHY=/ems.ZW1zLXByZC1hc3NldHMvbW92aWVzL2VlZGY0ZDI0LTljZDItNDEwZi1iM2ZkLWY1NTQ5Y2M3M2Q4Mi53ZWJw" />
                ...
                <div className='wrapper-item'>
                    ...
                    <p className='movie-title'>Knives Out</p>
